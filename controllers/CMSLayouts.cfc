<cfcomponent extends="Controller">
  ...
  <cffunction name="new">
    <cfset layout = model('CMSLayout').new()>
  </cffunction>

  <cffunction name="edit">
  	<cfset layout = model('CMSLayout').findByKey(params.key)>
    ...
    <cffunction name="create">
        <cfset layout = model('CMSLayout').new(params.layout)>
  ...
  <cffunction name="delete">
	...
	<cffunction name="reorder">
		<cfset layout = model("CMSLayout").reorder(order=params.order)>
